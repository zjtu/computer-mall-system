...
import com.cy.springboot.mapper.AddressMapper;
import com.cy.springboot.service.IAddressService;
...
public class AddressServiceImpl implements IAddressService {
    ...
    public void addNewAddress(Integer uid, String username, Address address) {
        ...
        // 判断数量是否达到上限值
        if (count > maxCount) {
            throw new AddressCountLimitException("收货地址数量已达到上限(" + maxCount + ")!");
        }
